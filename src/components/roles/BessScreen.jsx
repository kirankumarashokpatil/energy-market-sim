...
export default function BessScreen(props) {
    ...
    const gradient = currentSoc < 20 ? "linear-gradient(90deg, #f0455a, #f5b222)" : "linear-gradient(90deg, #1de98b, #38c0fc)";
        ...
        <div style={{ background: "#0c1c2a", border: "1px solid #1a3045", borderRadius: 8, padding: 16, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ marginBottom: 16, background: "#050e16", padding: "8px 12px", border: "1px solid #1a3045", borderRadius: 6 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
                    ...
                    <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 14, fontWeight: 900, color: currentSoc < 20 ? "#f0455a" : "#ddeeff" }}>{currentSoc}%</div>
                </div>
        ...
        <div style={{ flex: 1, background: "#08141f", border: "1px solid #1a3045", borderRadius: 8, padding: 16, display: "flex", flexDirection: "column" }}>
            ...
            {isDa && (
                <>
                    ...
                    <button onClick={onDaSubmit} disabled={daSubmitted || !daMyBid.price} style={{ marginTop: Math.max(0, 16 - (((daMyBid.side === "buy" && daMyBid.mw > sustainedChargeMw) || (daMyBid.side === "sell" && daMyBid.mw > sustainedDischargeMw)) ? 16 : 0)), width: "100%", padding: "12px", background: daSubmitted ? "#1a3045" : "#f5b222", border: "none", borderRadius: 6, color: daSubmitted ? "#4d7a96" : "#050e16", fontWeight: 800, fontSize: 12, cursor: daSubmitted ? "default" : "pointer" }}>
                ...
                <>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: "auto" }}>
                        <div>
                            ...
                            <input type="number" max={isShort ? sustainedDischargeMw : sustainedChargeMw} value={myBid.mw} disabled={submitted || phase !== "BM"} onChange={e => setMyBid(b => ({ ...b, mw: e.target.value }))} style={{ width: "100%", padding: "10px", background: "#102332", border: "1px solid #234159", borderRadius: 6, color: "#ddeeff", fontSize: 14, fontFamily: "'JetBrains Mono'", borderColor: (myBid.mw > (isShort ? sustainedDischargeMw : sustainedChargeMw)) ? "#f0455a" : "#234159" }} />
                        </div>
                        <div>
                    ...
                    <button onClick={onSubmit} disabled={submitted || phase !== "BM" || !myBid.price || (myBid.mw > (isShort ? sustainedDischargeMw : sustainedChargeMw))} style={{ marginTop: 16, width: "100%", padding: "12px", background: submitted || phase !== "BM" || (myBid.mw > (isShort ? sustainedDischargeMw : sustainedChargeMw)) ? "#1a3045" : (isShort ? "#38c0fc" : "#1de98b"), border: "none", borderRadius: 6, color: submitted || phase !== "BM" || (myBid.mw > (isShort ? sustainedDischargeMw : sustainedChargeMw)) ? "#4d7a96" : "#050e16", fontWeight: 800, fontSize: 12, cursor: submitted || phase !== "BM" || (myBid.mw > (isShort ? sustainedDischargeMw : sustainedChargeMw)) ? "default" : "pointer" }}>
